(function (c) {
    var k = {
        ...
        g = function (a, b, d) {
            ...
            b.timer = setTimeout(function () {
                ...
                if (d >= e && !0 !== a.repeat && !isNaN(a.repeat) && 0 < a.repeat) a.repeat -= 1;
                else if (a.pause && d >= e) return l(a, b, d + 1), !1;
                g(a, b, d + 1)
            }, a.speed / e)
        },
        l = function (a, b, c) {
    ...
    c.fn.pulsate = function (a) {
        ...
        if ("object" !== typeof a && a) c.error("Method " + a + " does not exist on jQuery.pulsate");
