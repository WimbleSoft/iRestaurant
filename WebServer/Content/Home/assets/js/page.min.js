! function (e) {
    ...
    ! function (t, n) {
                        ...
                        return 1 === i && 0 === o ? function (e) {
                            ...
                            if (g) {
                                ...
                                if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (b = (f = (c = (u = (d = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === x && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[m] || (b = f = 0) || h.pop();)
                                    ...
                                    for (;
                                        (p = ++f && p && p[m] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((u = (d = p[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] = [x, b]), p !== t)););
                    ...
                    if (n = i.relative[e[l].type]) p = [ye(be(p), n)];
                        ...
                        if ((n = i.filter[e[l].type].apply(null, e[l].matches))[w]) {
                            ...
                            return Te(l > 1 && be(p), l > 1 && ve(e.slice(0, l - 1).concat({
                                value: " " === e[l - 2].type ? "*" : ""
                            })).replace(R, "$1"), n, l < o && xe(e.slice(l, o)), o < r && xe(e = e.slice(o)), o < r && ve(e))
                        }
                        p.push(n)
                    }
                return be(p)
        ...
        S.event = {
            ...
            add: function (e, t, n, i, o) {
                ...
                if (g)
                    for (n.handler && (n = (r = n).handler, o = r.selector), o && S.find.matchesSelector(xe, o), n.guid || (n.guid = S.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
        ...
        function He(e, t, n, i) {
            ...
            if (p && (r = (o = Te(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
                ...
                if (a)
                    for (u = s[s.length - 1].ownerDocument, S.map(s, $e), d = 0; d < a; d++) l = s[d], he.test(l.type || "") && !J.access(l, "globalEval") && S.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? S._evalUrl && S._evalUrl(l.src) : T(l.textContent.replace(Le, ""), u, l))
            }
            return e
        }
        ...
        S.extend({
            ...
            clone: function (e, t, n) {
                ...
                if (t)
                    if (n)
                        for (r = r || ge(e), s = s || ge(u), i = 0, o = r.length; i < o; i++) Me(r[i], s[i]);
                    else Me(e, u);
        ...
        S.Animation = S.extend(ut, {
            ...
            prefilters: [function (e, t, n) {
                ...
                if ((l = !S.isEmptyObject(t)) || !S.isEmptyObject(f))
                    for (i in d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = J.get(e, "display")), "none" === (u = S.css(e, "display")) && (c ? u = c : (de([e], !0), c = e.style.display || c, u = S.css(e, "display"), de([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === S.css(e, "float") && (l || (p.done(function () {
                        h.display = c
        ...
        S.extend(S.event, {
            trigger: function (e, t, i, o) {
                ...
                if (a = f = l = i = i || s, 3 !== i.nodeType && 8 !== i.nodeType && !bt.test(g + S.event.triggered) && (g.indexOf(".") > -1 && (g = (v = g.split(".")).shift(), v.sort()), u = g.indexOf(":") < 0 && "on" + g, (e = e[S.expando] ? e : new S.Event(g, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : S.makeArray(t, [e]), p = S.event.special[g] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, t))) {
                    ...
                    for (r = 0;
                        (a = m[r++]) && !e.isPropagationStopped();) f = a, e.type = r > 1 ? c : p.bindType || g, (d = (J.get(a, "events") || {})[e.type] && J.get(a, "handle")) && d.apply(a, t), (d = u && a[u]) && d.apply && G(a) && (e.result = d.apply(a, t), !1 === e.result && e.preventDefault());
    ...
    window.$ = window.jQuery = n(0), window.Popper = n(4), n(5), window.SmoothScroll = n(7), window.objectFitPolyfill = n(8),
        function (e, t) {
            var n = {
                name: "TheSaaS",
                version: "2.0.0",
                    ...
                    computeStyle: {
                        ...
                        fn: function (e, t) {
                            ...
                            var s = void 0 !== r ? r : t.gpuAcceleration,
                                ...
                                h = void 0,
                                m = void 0;
                            if (m = "bottom" === d ? -a.height + c.bottom : c.top, h = "right" === p ? -a.width + c.right : c.left, s && f) l[f] = "translate3d(" + h + "px, " + m + "px, 0)", l[d] = 0, l[p] = 0, l.willChange = "transform";
                            else {
                                var g = "bottom" === d ? -1 : 1,
                                    v = "right" === p ? -1 : 1;
    ...
    (function (e, t, n) {
        ...
        var s = function (e) {
            ...
            }, e.fn.emulateTransitionEnd = n, i.supportsTransitionEnd() && (e.event.special[i.TRANSITION_END] = {
                bindType: t.end,
                delegateType: t.end,
                handle: function (t) {
                    ...
                    S = function () {
                        ...
                        return S.next = function () {
                            ...
                            var i = this._getItemIndex(t),
                                o = this._getItemIndex(e(this._element).find(x.ACTIVE_ITEM)[0]),
                                r = e.Event(h.SLIDE, {
                                    relatedTarget: t,
                                    direction: n,
                                    from: o,
                            ...
                            if (t === u ? (i = b, o = w, r = p) : (i = y, o = T, r = f), d && e(d).hasClass(g)) this._isSliding = !1;
                        ...
                        return v.toggle = function () {
                            ...
                            if (!this._isTransitioning && e(this._element).hasClass(u)) {
                                ...
                                if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                                    ...
                                    if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", s.reflow(this._element), e(this._element).addClass(p).removeClass(d).removeClass(u), this._triggerArray.length > 0)
            ...
            d = function (e) {
                var t = "dropdown",
                    ...
                    T = ".dropdown-menu",
                    x = ".navbar-nav",
                    S = ".dropdown-menu .dropdown-item:not(.disabled)",
                    k = "top-start",
                    C = "top-end",
                    E = "bottom-start",
                    _ = "bottom-end",
                    ...
                    N = function () {
                        ...
                        return w.toggle = function () {
                            ...
                            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                                for (var n = e.makeArray(e(b)), o = 0; o < n.length; o++) {
        ...
        }(t), e.Util = s, e.Alert = a, e.Button = l, e.Carousel = c, e.Collapse = u, e.Dropdown = d, e.Modal = p, e.Popover = h, e.Scrollspy = m, e.Tab = g, e.Tooltip = f, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    })(t, n(0), n(6))
}, function (e, t, n) {
                    ...
                    computeStyle: {
                        ...
                        fn: function (e, t) {
                            ...
                            var s = void 0 !== r ? r : t.gpuAcceleration,
                                ...
                                h = void 0,
                                m = void 0;
                            if (m = "bottom" === u ? -a.height + c.bottom : c.top, h = "right" === p ? -a.width + c.right : c.left, s && f) l[f] = "translate3d(" + h + "px, " + m + "px, 0)", l[u] = 0, l[p] = 0, l.willChange = "transform";
                            else {
                                var g = "bottom" === u ? -1 : 1,
                                    v = "right" === p ? -1 : 1;
    ...
    ! function () {
        ...
        function y() {
            if (!p && document.body) {
                ...
                var e = document.body,
                    ...
                    i = e.scrollHeight;
                if (f = document.compatMode.indexOf("CSS") >= 0 ? t : e, o = e, l.keyboardSupport && M("keydown", k), top != self) u = !0;
        ...
        function S(e) {
            ...
            }(i) || (Math.abs(n) > 1.2 && (n *= l.stepSize / 120), Math.abs(i) > 1.2 && (i *= l.stepSize / 120), x(r, n, i), e.preventDefault(), void O()) : !u || !X || (Object.defineProperty(e, "target", {
        ...
        var z, q = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function (e, t, n) {
        ...
        var Q, K = window.navigator.userAgent,
            G = /Edge/.test(K),
            X = /chrome/i.test(K) && !G,
            J = /safari/i.test(K) && !G,
            Z = /mobile/i.test(K),
            ee = /Windows NT 6.1/i.test(K) && /rv:11/i.test(K),
            te = J && (/Version\/8/i.test(K) || /Version\/9/i.test(K)),
            ne = (X || J || ee) && !Z;
    ...
    ! function () {
        ...
        function n() {
            if (h.length) {
                ...
                var e = f || !m || m.width !== u || m.height !== d,
                    t = e || !m || m.y !== p;
        ...
        var i = function () {
            ...
            a = s.toLowerCase().indexOf("android") > -1,
        ...
        var h = [],
            ...
            v = function () {
                ...
                return i(e, [{
                    ...
                    value: function () {
                        ...
                        n.position = e.image.position, e.css(e.image.$item, n), e.image.$container.appendChild(e.image.$item), e.coverImage(), e.clipContainer(), e.onScroll(!0), e.options.onInit && e.options.onInit.call(e), "none" !== e.css(e.$item, "background-image") && e.css(e.$item, {
            ...
            y = function (e) {
                ...
                for (var t = arguments[1], n = Array.prototype.slice.call(arguments, 2), i = e.length, r = 0, s = void 0; r < i; r++)
                    if ("object" === (void 0 === t ? "undefined" : o(t)) || void 0 === t ? e[r].jarallax || (e[r].jarallax = new v(e[r], t)) : e[r].jarallax && (s = e[r].jarallax[t].apply(e[r].jarallax, n)), void 0 !== s) return s;
                return e
            };
        y.constructor = v;
            ...
            u = {
                ...
                handlers: {
                    ...
                    youtube: function (e) {
                        var n = p.exec(e);
                        if (!n) return !1;
                        return S(T(e, w("https://www.youtube" + (n[2] || "") + ".com/embed/" + n[4], t.extend({
                            autoplay: 1
                        }, b(n[5] || "")))))
                    },
                    vimeo: function (e) {
                        var n = f.exec(e);
                        if (!n) return !1;
                        return S(T(e, w("https://player.vimeo.com/video/" + n[3], t.extend({
                            autoplay: 1
                        }, b(n[4] || "")))))
                    },
                    googlemaps: function (e) {
                        var t = h.exec(e);
                        if (!t) return !1;
                        return S(T(e, w("https://www.google." + t[3] + "/maps?" + t[6], {
                    ...
                    facebookvideo: function (e) {
                        ...
                        return S(T(e, w("https://www.facebook.com/plugins/video.php?href=" + e, t.extend({
                            autoplay: 1
                        }, b(n[4] || "")))))
                    },
                    iframe: S
    ...
    i = function () {
        ...
        function E(e, t) {
            ...
            return e.addEventListener(S, i), x[n] = {
                element: e,
                listener: i
            }, n
        }
            ...
            return Object.keys(n).forEach(function (e) {
                ...
                if (c > 0) {
                    ...
                    (d = s.every(function (e) {
                        var t = new p(e.left + c, e.top, e.width, e.height, e.id),
                            n = !i.some(function (e) {
            ...
            j = function (e) {
                ...
                return function (e, t) {
                    ...
                    value: function (e) {
                        ...
                        var i = this._filter(this.lastFilter, n),
                            o = T(this._mergeNewItems(i.visible), this.lastSort),
